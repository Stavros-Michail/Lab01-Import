...
**Not arithmetic as there is data inputted in the column n_2021 that is NA, thus the mean function cannot run**
...
**The median is the middle value of the number of visitors for all attractions. The mean is skewed by extreme values. Since, the mean is larger than the median, we can conclude there are attractions with a large number of visitors.**
